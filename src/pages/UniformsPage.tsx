...
//                     {uniform.player.fullName}
//                   </td>
//                   <td className="p-4 text-gray-600">
//                     {uniform.player.birthYear}
//                   </td>
//                   <td className="p-4 text-gray-600">
//                     {uniform.size.replace("SIZE_", "")}
//                   </td>
//                   <td className="p-4 text-gray-600">
//                     {uniform.amount.toLocaleString()} EGP
//                   </td>
//                   <td className="p-4">
//                     <span
...
//               onChange={(e) =>
//                 setFormData((prev) => ({ ...prev, hasPaid: e.target.checked }))
//               }
//             />
